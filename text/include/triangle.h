...
public:
    ...
    {
        oc.x=(float )((p2.y-p1.y)*(p3.y*p3.y-p1.y*p1.y+p3.x*p3.x-p1.x*p1.x)-(p3.y-p1.y)*(p2.y*p2.y-p1.y*p1.y+p2.x*p2.x-p1.x*p1.x))/(2*(p3.x-p1.x)*(p2.y-p1.y)-2*(p2.x-p1.x)*(p3.y-p1.y));
        oc.y=(float )((p2.x-p1.x)*(p3.x*p3.x-p1.x*p1.x+p3.y*p3.y-p1.y*p1.y)-(p3.x-p1.x)*(p2.x*p2.x-p1.x*p1.x+p2.y*p2.y-p1.y*p1.y))/(2*(p3.y-p1.y)*(p2.x-p1.x)-2*(p2.y-p1.y)*(p3.x-p1.x));
...
{
    return str << "Triangle:" << std::endl << "\t" << t.p1 << std::endl << "\t" << t.p2 << std::endl << "\t" << t.p3 << std::endl << "\t" << t.oc<< std::endl << "\t" << t.e1 << std::endl << "\t" << t.e2 << std::endl << "\t" << t.e3 <<std::endl;
